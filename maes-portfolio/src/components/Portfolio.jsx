...
import mae5 from '../assets/images/mae5.jpg'; // Ensure this matches the actual file
import mae6 from '../assets/images/mae6.jpg';
import maevid from '../assets/videos/maevid.mp4';
import journey from '../assets/videos/journey.mp4';
import maevid4 from '../assets/videos/maevid4.mp4';
...
const Portfolio = () => {
  ...
  const photoItems = [
    {
      image: mae3,  // Fixed: no curly braces
      title: "Tin Roof 2024",
      location: "Delray Beach, FL",
      alt: "Performance 1"
    },
    {
      image: mae5,  // Fixed: no curly braces
      title: "Tin Roof 2024",
      location: "Delray Beach, FL",
      alt: "Performance 1"
    },
    {
      image: mae6,  // Fixed: no curly braces
      title: "Elbow Room",
  ...
  const videoItems = [
    {
      video: maevid,  // Fixed: no curly braces
      title: "Long Way to the Top",
      location: "Jhonnie Brown's",
      alt: "Video 1"
    },
    {
      video: journey,  // Fixed: no curly braces
      title: "Don't Stop Believin'",
      location: "Fair Grounds",
      alt: "Video 2"
    },
    {
      video: maevid4,  // Fixed: no curly braces
    ...
    return (
      <>
        ...
        <div className="relative w-full max-w-4xl mx-auto perspective-1000 h-[400px] flex items-center justify-center">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/75 p-3 rounded-full transition-colors z-30"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-black/50 hover:bg-black/75 p-3 rounded-full transition-colors z-30"
